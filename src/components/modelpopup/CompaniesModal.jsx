                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        ...
                        <input className="form-control" type="text" placeholder='Eg. ABC' />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                    ...
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        ...
                        <input className="form-control" type="text" placeholder='Eg. 9708968596'/>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Phone Number 2 <span className="text-danger"> *</span></label>
                        <input className="form-control" type="text" placeholder='Eg. 9456765566'/>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Fax <span className="text-danger"> *</span></label>
                        <input className="form-control" type="text" placeholder='Eg. +1 46546467'/>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Website</label>
                        <input className="form-control" type="text" placeholder='Eg. www.abc.com'/>
                      </div>
                    </div>										
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                    ...
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        ...
                        <input className="input-tags form-control" id="inputBox" type="text" data-role="tagsinput" name="Label" defaultValue="Eg. Featured" />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                    ...
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        ...
                        <textarea className="form-control" rows={5} defaultValue={""} placeholder='Write description about company here ...'/>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        ...
                        <input className="form-control" type="text" placeholder='Eg. 123 Main St, Anytown, USA' />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="col-form-label">City <span className="text-danger"> *</span></label>
                        <input className="form-control" type="text" placeholder='Eg. Chicago' />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="col-form-label">State / Province <span className="text-danger"> *</span></label>
                        <input className="form-control" type="text" placeholder='Eg. Illinois' />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                    ...
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        ...
                        <input className="form-control" type="text" placeholder='Eg. 547434'/>
                      </div>
                    </div>
                    <div className="col-lg-12 text-end form-wizard-button">
                      <button className="button btn-lights reset-btn" type="reset">Reset</button>
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        ...
                        <input className="form-control" type="text" placeholder='Eg. https://www.facebook.com/yourcompany' />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Twitter</label>
                        <input className="form-control" type="text" placeholder='Eg. https://www.twitter.com/yourcompany' />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Linkedin</label>
                        <input className="form-control" type="text" placeholder='Eg. https://www.linkedin.com/company/yourcompany' />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Skype</label>
                        <input className="form-control" type="text" placeholder='Eg. https:www.skype.com/' />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Whatsapp</label>
                        <input className="form-control" type="text" placeholder='Eg. https://www.whatsapp.com/9659549696' />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
                        <label className="col-form-label">Instagram</label>
                        <input className="form-control" type="text" placeholder='Eg. https://www.instagram.com/yourcompany' />
                      </div>
                    </div>	
                    <div className="col-lg-12">
                      <div className="input-block mb-3">
