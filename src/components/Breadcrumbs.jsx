  ...
  if (
        ...
        <div className="col">
          ...
          <ul className="breadcrumb">
            <li className="breadcrumb-item">
              <Link to={getDashboardLink()}>{props.title}</Link>
            </li>
      ...
      <div className="row align-items-center">
        ...
        <div className="col-auto float-end ms-auto">
          <Link
            ...
            onClick={props.onAddClick} // reset state on add
          >
          ...
          <div className="view-icons">
            <Link
              ...
              className={`grid-view btn btn-link mx-2 ${
                location.pathname === props.Linkname
            ...
            <Link
              ...
              className={`list-view btn btn-link ${
                location.pathname === props.Linkname1
                  ? "bg-primary text-white"
                  : ""
              }`}
            >
    ...
    addButton = (
      <div className="row align-items-center">
        ...
        {/* ✅ Hide button when hideButton={true} is passed */}
        {!props.hideButton &&
          (LogInuserRole === "Admin" || props.forceShowButton) && (
            <div className="col-auto float-end ms-auto">
              <Link
                to="#"
                className="btn add-btn"
