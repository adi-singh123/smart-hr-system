    ...
    menu: [
      ...
      },
      {
        ...
        subMenus: [
          ...
          ...(UserRole() === "Admin"
            ? [
                { menuValue: "Chats", route: "/chat" },
                { menuValue: "Contacts", route: "/contacts" },
                // { menuValue: "Email", route: "/inbox" },
              ]
            : []),
        ],
      },
    ...
    menu: [
      {
        ...
        subMenus: [
          ...
          // ...(UserRole() === "Admin"
          //   ? [
          //       { menuValue: "Leaves(Admin)", route: "/adminleaves" },
          //       { menuValue: "Attendance (Admin)", route: "/adminattendance" },
          //     ]
          //   : []),
        ],
      },
      ...
      },
      {
        ...
        subMenus: [
          {
            menuValue: "Images",
            route: "/template-firm/images",
          },
          {
            menuValue: "Categories",
            route: "/template-firm/categories",
          },
          {
            menuValue: "Sub Categories",
            route: "/template-firm/sub-categories",
          },
          {
            menuValue: "Child Sub Categories",
            route: "/template-firm/child-sub-categories",
          },
        ],
      },
    ],
    ...
    menu: [
      ...
      },
      {
        ...
        subMenus: [
          ...
          {
            menuValue: "Intern Candidates List",
            route: "/intern-candidates",
          },
          {
