...
import { AdminSidebarData, EmployeeSidebarData } from "./sidebardata";
...
const Sidebar = () => {
  ...
  const [sidebarData, setSidebarData] = useState(
    UserRole() === "Admin" ? AdminSidebarData : EmployeeSidebarData
  );
                ...
                {isSideMenu == "jobs" ? (
                  <ul>
                    ...
                    <li>
                      <Link
                        className={
                          pathname === "/intern-candidates" ? "active" : ""
                        }
                        to="/intern-candidates"
                      >
                        {t("Intern Candidate List")}
                      </Link>
                    </li>
                    <li>
                      <Link
