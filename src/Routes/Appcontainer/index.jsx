...
import TemplateFirm from "../../views/pages/Administration/TemplateFirm/Images/Index";
...
import Historian from "../../views/pages/Administration/Historian/Index.jsx";
...
import TemplateFirmCategory from "../../views/pages/Administration/TemplateFirm/Category/Index.jsx";
import TemplateFirmSubCategory from "../../views/pages/Administration/TemplateFirm/SubCategory/Index.jsx";
import TemplateFirmChildSubCategory from "../../views/pages/Administration/TemplateFirm/ChildSubCategory/Index.jsx";
import ProfileTab from "../../views/pages/Profile/ProfileTab.jsx";
import InternCandidatesList from "../../views/pages/Administration/Jobs/InternCanditatesList/index.jsx";
...
const AppContainer = () => {
  ...
  const AdministrationRoutingeObjects = [
    ...
    },
    {
      id: 24,
      path: "template-firm",
      element: <TemplateFirm />,
    },
    {
      id: 24,
      path: "template-firm/categories",
      element: <TemplateFirmCategory />,
    },
    {
      id: 24,
      path: "template-firm/sub-categories",
      element: <TemplateFirmSubCategory />,
    },
    {
      id: 24,
      path: "template-firm/child-sub-categories",
      element: <TemplateFirmChildSubCategory />,
    },
    {
      id: 25,
      path: "intern-candidates",
      element: <InternCandidatesList />,
    },
  ];
